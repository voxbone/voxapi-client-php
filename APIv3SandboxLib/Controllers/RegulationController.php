...
class RegulationController {
     ...
     * @return AddressListModel response from the API call*/
     ...
     * @return ZipCodeListModel response from the API call*/
     ...
     * @return AddressValidResponseModel response from the API call*/
