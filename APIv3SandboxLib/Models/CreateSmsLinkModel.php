...
class CreateSmsLinkModel {
    ...
    public function __construct()
    {
        if(12 == func_num_args())
        {
            ...
            $this->weight = func_get_arg(6);
            $this->direction = func_get_arg(7);
            $this->systemType = func_get_arg(8);
            $this->useSSL = func_get_arg(9);
            $this->monitorInterval = func_get_arg(10);
            $this->transactionTimeout = func_get_arg(11);
        }
    }
