...
class AddressListModel {
     ...
     * @param array $regulationAddresses public property
     */
    protected $regulationAddresses;
	 ...
	 * @param   array $regulationAddresses    Initialization value for the property $this->regulationAddresses
    ...
    public function __construct()
    {
        if(2 == func_num_args())
        {
            $this->regulationAddresses = func_get_arg(0);
