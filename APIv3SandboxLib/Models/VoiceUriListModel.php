...
class VoiceUriListModel {
    /**
     * The list of voice URIs
     * @param array $voiceUris public property
     */
    protected $voiceUris;
	 ...
	 * @param   array $voiceUris    Initialization value for the property $this->voiceUris
